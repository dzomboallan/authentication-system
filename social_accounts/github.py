...
class Github():
    ...
    def exchange_code_for_token(code):
        params_payload = {"client_id":settings.GITHUB_CLIENT_ID, "client_secret":settings.GITHUB_CLIENT_SECRET, "code":code}
    ...
    def get_github_user(access_token):
        try:
            ...
            raise AuthenticationFailed("Invalid access token", 401)